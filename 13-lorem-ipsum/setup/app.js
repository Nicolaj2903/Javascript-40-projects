...
const amount = document.getElementById('amount');   // getElementById(), because it's a form that uses 'for='
const result = document.querySelector('.lorem-text');

form.addEventListener('submit', function (event) {
  event.preventDefault();
  const value = parseInt(amount.value); // By default the form input is a string not an integer
